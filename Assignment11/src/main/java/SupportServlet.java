...
public class SupportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.print("<p>Thank you! " + fname + " for contacting us. You  should receive reply from us within 24 hrs" +
                " in your email address " + femail + ". Let us know in our support email " + sc.getInitParameter("support-email") +
